    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative container-custom section-padding">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl lg:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto text-pretty leading-relaxed">
        ...
        <section className="section-padding bg-gray-50">
          <div className="container-custom">
            <div className="text-center mb-16">
              <h3 className="text-4xl font-bold mb-4 text-gray-900">Why Choose Us</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="card card-hover p-8 text-center group">
                ...
                <h4 className="text-2xl font-semibold mb-4 text-gray-900">Lightning Fast</h4>
              ...
              <div className="card card-hover p-8 text-center group">
                ...
                <h4 className="text-2xl font-semibold mb-4 text-gray-900">Modern React</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="card card-hover p-8 text-center group">
                ...
                <h4 className="text-2xl font-semibold mb-4 text-gray-900">Beautiful Design</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="card card-hover p-8 text-center group">
                ...
                <h4 className="text-2xl font-semibold mb-4 text-gray-900">Fully Responsive</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="card card-hover p-8 text-center group">
                ...
                <h4 className="text-2xl font-semibold mb-4 text-gray-900">Component-Based</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="card card-hover p-8 text-center group">
                ...
                <h4 className="text-2xl font-semibold mb-4 text-gray-900">Best Practices</h4>
                <p className="text-gray-600 leading-relaxed">
        ...
        <section className="section-padding">
          <div className="container-custom">
            <div className="card p-12 text-center bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-200">
